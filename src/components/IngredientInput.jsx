  ...
  return (
    <div className="w-full space-y-4">
      ...
      <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
        <h3 className="font-medium mb-1 text-gray-700">Tambah Banyak Bahan Sekaligus</h3>
        <p className="text-xs text-gray-500 mb-3">
          Pisahkan dengan koma atau baris baru (Enter).
        </p>
        <div className="flex flex-col space-y-2">
          <Textarea
            value={multiInput}
            onChange={(e) => setMultiInput(e.target.value)}
            placeholder="Contoh: Tomat, Bawang Merah, Daging Sapi"
            className="min-h-[60px] w-full text-sm"
            rows={2}
          />
          <Button 
            onClick={handleAddMultipleIngredients}
            className="w-full bg-foodie-500 hover:bg-foodie-600 text-white"
            disabled={!multiInput.trim()}
          >

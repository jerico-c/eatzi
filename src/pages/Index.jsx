        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-5 rounded-lg shadow-md text-center">
              ...
              <h3 className="font-semibold mb-2">Masukin Bahannya</h3>
              <p className="text-gray-600">Masukin bahan makanan yang kamu punya</p>
            </div>
            ...
            <div className="bg-white p-5 rounded-lg shadow-md text-center">
              ...
              <h3 className="font-semibold mb-2">Cari Resepnya</h3>
              <p className="text-gray-600">Cari resep yang sesuai sama kamu</p>
            </div>
            ...
            <div className="bg-white p-5 rounded-lg shadow-md text-center">
              ...
              <h3 className="font-semibold mb-2">Masak & Enjoy</h3>
              <p className="text-gray-600">Ikutin resepnya dan enjoy makan</p>
            </div>
          </div>
        </div>
      </div>

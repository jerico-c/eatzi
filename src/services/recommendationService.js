...
const CANONICAL_TO_KEYWORDS_MAP = {
    ...
    'Daging Unggas': ['daging unggas', 'ayam', 'itik', 'bebek'], // 'unggas' lebih umum
    'Ikan': ['ikan', 'tongkol', 'lele', 'gurame'], // contoh jenis ikan
    'Jagung': ['jagung'],
    'Jahe': ['jahe'],
    ...
    'Nasi': ['nasi'],
    'Petai': ['petai', 'pete'],
    'Sawi': ['sawi', 'sawi hijau', 'caisim', 'pakcoy'], // Jenis sawi
    'Selada': ['selada'],
    'Seledri': ['seledri'],
    'Telur Ayam': ['telur ayam', 'telur'], // Default 'telur' ke telur ayam
...
class RecommendationService {
    ...
    async init(datasetPath = '/dataset_gento.csv') {
...
// export { VOCABULARY }; // Uncomment jika VOCABULARY dibutuhkan di komponen input
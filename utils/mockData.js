...
export const getRecipesByIngredients = (ingredientIds) => {
...
export const getRecipesByDietaryPreferences = (preferences) => {
...
export const getFilteredRecipes = (ingredientIds, preferences) => {
